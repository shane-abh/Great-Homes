...
export default function Contact() {
	...
	const scriptURL =
		"https://script.google.com/macros/s/AKfycbwlcPLDuwLuW8tOiDhWo20vrEt7ZVFQrBN3ptLUms0Ln9JIVwO2FAf3xVph12Uft0h-Hg/exec";
		...
		<div className="contact-page">
			...
			<div className="container mx-auto p-4">
				<div className="text-center mb-8">
					<h2 className="text-2xl font-bold mb-2 pt-4">
