  ...
  return (
    <div>
      ...
      <div className="bg-black bg-cover bg-center inset-0 min-h-[90dvh]" style={{
        ...
        <div className=" flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto z-10 text-gray-600 bg-black/0" >
          <h1 className="text-4xl lg:text-6xl text-center  font-cursiveFont ">
            Find your dream
            <br/> 
            Here
          </h1>
          <div className="text-xs sm:text-sm  items-center justify-center ">
            <Search/>
          </div>
          {/* <Link
            to={"/search"}
